...
include("../Model/db.php");
 session_start();
  //include('../control/touristregistrationcontrol.php');
...
<head>
    ...
    <title>Registration As a Tourist</title>
</head>
...
<body bgcolor="MediumSeaGreen">
    ...
    <p><strong><font color="black">To Do Further Work, Please Register First</font></strong></p>
    <br><br><br><br>
            ...
            <tr>
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="password" name="confirmpassword"placeholder="Enter your password"><?php echo $confirmPasswordErr;?> <br><br>
                        </td>
                    </tr>
