function fnamecheck_adminregistration()
{
    ...
    else
    {
        ...
        document.getElementById("fnameerr").innerHTML = "Firstname format ok";
        return true;
    }
}
...
function usernamecheck_admin()
{
    ...
    else
    {
        ...
        document.getElementById("nameerr").innerHTML = "username format ok";
        return true;
    }
}
...
function nid_adminregistration()
{
    ...
    else if(nid.length == 8 && !isNaN(nid))
    {
        ...
        document.getElementById("niderr").innerHTML = "NID format is valid";
        return true;
    }
    else
    {
...
function password_adminregistration()
{
    ...
    else
    {
        ...
        document.getElementById("passerr").innerHTML = "password format ok";
        return true;
    }
}
...
function email_AJAX()
{
    ...
    emailxhttp.open("POST", "http://localhost/final/Admin/Control/ajax.emailcheck.php", true);
...
function registration_email_AJAX()
{
    ...
    emailxhttp.open("POST", "http://localhost/final/Admin/Control/ajax.emailcheck_registration.php", true);
    emailxhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
    emailxhttp.send("email="+email);
}
...
function registration_phone_AJAX()
{
    ...
    phonexhttp.open("POST", "http://localhost/final/Admin/Control/ajax.phonecheck_registration.php", true);
